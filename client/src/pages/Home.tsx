...
export default function Home() {
  ...
  return (
    <main id="top" className="site-shell">
      ...
      <section id="contato" className="contact-section"><div className="container contact-card"><div className="contact-content"><div className="section-kicker">04 / Vamos conversar</div><h2>Qual processo<br />pode ser <span>melhor?</span></h2><p>Conte onde sua empresa quer chegar. A gente ajuda a encontrar o próximo passo.</p><a className="button button-primary" href="mailto:contato@scalio.com.br">contato@scalio.com.br <ArrowUpRight size={17} /></a></div><div className="contact-orbit"><div className="orbit-core"><Network size={31} /></div><span className="orbit-label label-one">IA</span><span className="orbit-label label-two">RPA</span><span className="orbit-label label-three">CLOUD</span><span className="orbit-label label-four">SECURITY</span></div></div></section>
